class User < ApplicationRecord
  ...
  before_destroy :must_not_destroy_last_one_admin_user
  before_update :must_not_update_last_one_admin_user
  ...
  # if admin_change
  #最後の1人の管理者ユーザーを削除しない
  def must_not_destroy_last_one_admin_user
  ...
  def must_not_update_last_one_admin_user
